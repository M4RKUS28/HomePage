        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
              Welcome to{" "}
              <span className="text-blue-600">M4RKUS</span>
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Modern React applications with Next.js, TypeScript, and Tailwind CSS
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Robust APIs with FastAPI, Python, and PostgreSQL databases
              </p>
            </div>
            ...
            <div className="text-center p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Complete end-to-end applications with deployment and maintenance
              </p>
            </div>
          </div>
        </div>
