"""
Alembic env.py for the refactored backend.

Uses the *synchronous* psycopg driver (settings.db.sync_url) because
...
# Override sqlalchemy.url from application settings (sync URL for Alembic)
